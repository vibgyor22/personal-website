...
export const projects: Project[] = [
  {
    ...
    summary:
      "An agentic econometric engine — you ask a question in plain English, load a CSV, and Espresso picks the right model, runs diagnostics, and explains the results.",
    bullets: [
      "Runs DiD, Panel OLS, ARIMA, IV, quantile regression — 15+ estimators, picked by looking at what the data structure actually calls for",
      "If a diagnostic fails mid-run — say Hausman rejects random effects — it switches model and explains why in plain English",
      "The LLM handles language only. All regression math runs through statsmodels and scipy — nothing estimated by the model itself",
      "Gives you a terminal REPL, an HTML dashboard you can share, and LaTeX-ready tables as output",
      "Profiles the dataset before touching it — checks variable types, missingness, and outliers before any modeling begins",
    ],
  ...
  },
  {
    ...
    summary:
      "I simulated U.S. debt-ceiling negotiations as a war-of-attrition game where LLM agents play Hawk and Dove negotiators reacting to real market stress data.",
    bullets: [
      "The model is Alesina & Drazen (1991) — a war of attrition where both sides wait for the other to blink first. I wanted to see if LLM agents would reproduce that pattern",
      "80 runs across 2011, 2013, and 2023 debt crises, plus a fictional 2025 where the X-date actually hits and default occurs",
      "Each round, agents observe real data — VIX levels, T-bill spreads, polling numbers, debt/GDP, and days remaining until default",
      "Only three choices per turn: HOLD, SIGNAL_FLEXIBILITY, or CONCEDE. The delay dynamics emerge from the game, not from scripted logic",
      "Cox hazard models on the results confirmed VIX spikes above 30 significantly accelerated concession timing across all episodes",
    ],
    github: "https://github.com/vibgyor22/llm-war-of-attrition",
    tags: ["Python", "Game Theory", "LLM Agents", "Streamlit"],
    theme: "attrition",
    stats: [
      { label: "Simulation runs", value: "80" },
      { label: "Crisis episodes", value: "4" },
      { label: "Model", value: "Alesina-Drazen" },
      { label: "Regression", value: "Cox Hazard + OLS" },
    ],
  },
];
